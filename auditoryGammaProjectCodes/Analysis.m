...
for ind = 1: length(subjectName)
    ...
    [TrialSortedData{ind},TrialAverageData{ind},fftStim{ind},powStim{ind},AvgPow_acrssElecs{ind},powChange{ind},TimeVals{ind},FreqVals{ind},uRf,uRv,Samp_Freq] = getValGamma(ind,subjectName,expDate,protocolNames,folderSourceString,gridType,timeRange,good_elecs);
end
