...
function [TrialSortedData,TrialAverageData,fftStim,powStim,avgPow_acrssElecs,powChange,TimeVals,FreqVals,uRf,uRv,Fs] = getValGamma(index,subjectName,expDate,protocolNames,folderSourceString,gridType,timeRange,good_elecs,useERP,params)
